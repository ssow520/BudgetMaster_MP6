...
export const logout = (req, res) => {
  try {
    // La déconnexion côté client supprime simplement le token
    // Côté serveur, on peut enregistrer la déconnexion
...
/**
 * Vérifie si le token est valide (endpoint pour tester)
 */
