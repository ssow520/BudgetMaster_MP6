/**
 * TransactionService
 * Gère les opérations sur les transactions (revenus et dépenses)
 */
...
class TransactionService {
  ...
  /**
   * Obtient les revenus d'un utilisateur
   */
  ...
  /**
   * Obtient les dépenses d'un utilisateur
   */
  ...
  /**
   * Filtre les transactions par type, catégorie et/ou période
   */
  static filter(userId, filters) {
    try {
      ...
      // Filtrer par catégorie (pour les dépenses)
      if (filters.category) {
