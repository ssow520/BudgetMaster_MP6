...
test('getInstance() retourne toujours la limitême référence', async () => {
...
const { default: Database } = await import('../config/database.js');
  ...
  test('loadDatabase() retourne le limitême objet en limitémoire', async () => {
...
const { loadDatabase, saveDatabase } = await import('../config/database.js');
  ...
  test('montant amountégatif est invalide', () => {
